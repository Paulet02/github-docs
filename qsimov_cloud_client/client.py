...
class QsimovCloudClient(object):
    ...
    def set_state(self, bin=None, num_qubits=None, state=None):
        """Set the initial state for the quantum computation.

        Args:
            bin (str): Binary representation of the quantum state.
            num_qubits (int): Number of qubits (if bin is not provided).
            state (int): Integer representation of the quantum state (if bin is not provided).
